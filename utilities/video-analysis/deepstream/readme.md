...
1. DeepStream 5.1 requires JetPack 4.5 or above, if the Jetson device you are using has a lower version, please update it by following these [instructions](https://docs.nvidia.com/jetson/jetpack/install-jetpack/index.html).
